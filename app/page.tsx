...
import Images from "../components/sections/Image";
      ...
      <div className={styles.side_by_side} >
        <section className={styles.menulist} >
          <div className={styles.container}>
            <Link className={styles.menu} ref={resumeRef} style={{ transform: resumeIsInView ? "none" : "translateX(-100%)", opacity: resumeIsInView ? 1 : 0 }} href="https://raw.githubusercontent.com/PapopLekha/RESUME/master/pdf/resume-hpc.pdf" passHref>
